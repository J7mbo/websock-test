...
apt-get -y install socat rabbitmq-server librabbitmq-dev
chown -R www-data:www-data /var/www/

# Errors are off by default - we don't want this
sed -i.bak s/"display_errors = Off"/"display_errors = On"/g /etc/php/7.1/apache2/php.ini

# Update pecl
pecl channel-update pecl.php.net
printf "\n" | sudo pecl install amqp

# Amqp enabling apache
echo '' | tee --append /etc/php/7.1/apache2/php.ini
echo ';;;;;;;;;;;;;;;;;;;;;;;;;;' | tee --append /etc/php/7.1/apache2/php.ini
echo ';; Added to enable AMQP ;;' | tee --append /etc/php/7.1/apache2/php.ini
echo ';;;;;;;;;;;;;;;;;;;;;;;;;;' | tee --append /etc/php/7.1/apache2/php.ini
echo '' | tee --append /etc/php/7.1/apache2/php.ini
echo 'extension=amqp.so' | tee --append /etc/php/7.1/apache2/php.ini

# Amqp enabling cli
echo '' | tee --append /etc/php/7.1/cli/php.ini
echo ';;;;;;;;;;;;;;;;;;;;;;;;;;' | tee --append /etc/php/7.1/cli/php.ini
echo ';; Added to enable AMQP ;;' | tee --append /etc/php/7.1/cli/php.ini
echo ';;;;;;;;;;;;;;;;;;;;;;;;;;' | tee --append /etc/php/7.1/cli/php.ini
echo '' | tee --append /etc/php/7.1/cli/php.ini
echo 'extension=amqp.so' | tee --append /etc/php/7.1/cli/php.ini
